...
import 'package:restoo/core/services/food_services.dart';
import 'package:restoo/ui/widgets/custom_textfield.dart';
...
class _UpdateFoodState extends State<UpdateFood> {
  ...
  void updateMakanan() async {
    if (titleController.text.isNotEmpty &&
      ...
      var result = await FoodServices.update(foodModel, widget.foodModel.id);
